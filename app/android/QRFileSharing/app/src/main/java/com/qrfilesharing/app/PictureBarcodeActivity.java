...
public class PictureBarcodeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final int RETURN_QRCODE_CONTENTS = 202;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST && resultCode == RESULT_OK) {
            ...
            try {
                String displayValue = new String("Nothing");
                ...
                Log.i(TAG, "DAB: I got this from the qrcode scan: " + displayValue);
                qrCodeContents = new QRCodeContents(displayValue);
                MainActivity.qrFileSharingWebSocket.receiveFile(qrCodeContents);
                finish();
            } catch (Exception e) {
    ...
    private void takeBarcodePicture() {
        ...
        File myImageDir = new File(context.getExternalCacheDir(), "my_images");
        File photo = new File(myImageDir, "pic.jpg");
        imageUri = FileProvider.getUriForFile(Objects.requireNonNull(context),
